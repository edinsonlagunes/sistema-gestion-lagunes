...
def listar_cajas(negocio_id: int | None = None, db: Session = Depends(get_db)):
...
def eliminar_movimiento(
    ...
    """Quita un movimiento registrado por error, junto con su egreso si era un gasto. Solo administradores."""
    movimiento = (
